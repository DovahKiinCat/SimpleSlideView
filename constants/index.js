export const Icons = {
    Firsts: [
        {url: ".twitter.com/DovahkiinCat", hover: false},
        {url: ".github.com/DovahKiinCat", hover: false},
        {url: ".instagram.com/", hover: false},
        {url: ".youtube.com/", hover: false}
    ],
    color: {
        primary: "black",
        bg: "transparent"
...
export const textslide = [
    ...
    "text super divertido uau s[o para testar aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
