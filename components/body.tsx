    ...
    return (
        ...
        <section className='flex flex-col justify-center h-screen w-full'>
            <section className='mx-auto'>
                ...
                >
                    <section className='font-bold text-white text-4xl tracking-wide p-2'>
                        <h1>Lorem ipsum...</h1>
                    </section>
                </motion.div>
                ...
                <motion.div
                    ...
                    transition={{ delay: 0.25 }}
                >
                    <section className='relative bg-white w-[700px] h-[300px] rounded-2xl shadow'>
            ...
            <section className='w-full flex flex-row justify-between absolute :hover cursor-pointer'>
